...
public class UserController {
    ...
    public UserDTO queryUserById(
        ...
        return BeanUtils.copyBean(userDetail, UserDTO.class, (d, u) -> u.setRole(d.getRole().getValue()));
    }
     ...
     * @return 登录用户信息
     */
    @ApiOperation("登录时查询比对用户信息")
    @PostMapping("/detail")
    public LoginUserDTO queryUserDetail(@Valid @RequestBody LoginFormDTO loginDTO) {
